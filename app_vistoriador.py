# -*- coding: utf-8 -*-
# ------------------------------------------------------------
# Painel de Produção por Vistoriador (Streamlit) - MULTI-MESES (LOG VISTORIAS)
...
# CONFIG BÁSICA
# =========================
st.set_page_config(page_title="🧰 Produção por Vistoriador - LOG VISTORIAS (multi-meses)", layout="wide")
st.title("🧰 Painel de Produção por Vistoriador - LOG VISTORIAS")

# === Planilha-Índice (ARQUIVOS) ===
# Usa o secrets se existir; caso não exista, usa este ID fixo (LOG VISTORIAS).
